...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://www.docusign.net/restapi';
     ...
     * @var string
     */
    protected $userAgent = 'Swagger-Codegen/v2.1/8.0.0/php/' . PHP_VERSION;
    ...
    {
        $report  = 'PHP SDK (DocuSign\eSign) Debug Report:' . PHP_EOL;
